        ...
        if (event == "telemetry") {
          ...
          //   of the road.
            ...
            for ( int i = 0; i < sensor_fusion.size(); i++ ) 
            {
                ...
                double check_dist = 28.0;
                double check_offset = 15.0;

                check_car_s += ((double)prev_size*0.02*check_speed);
                
                if ( car_lane == lane ) 
                {
                  car_ahead |= check_car_s > car_s && check_car_s - car_s <= check_dist;
                } 
                else if ( car_lane - lane == -1 ) 
                {
                  car_left |= car_s - check_dist + check_offset <= check_car_s && car_s + check_dist >= check_car_s;
                } 
                else if ( car_lane - lane == 1 ) 
                {
